 ...
 *  @trigger_counter	iio trigger internal counter.
 *  @trigger_rate_divider iio trigger rate divider;
 *  @trigger_lock	iio trigger spin lock.
...
#define INV_MPU6050_BIT_TEMP_RESET          0x01
#define INV_MPU6050_BIT_ACCEL_RESET         0x02
#define INV_MPU6050_BIT_GYRO_RESET          0x04
...
#define INV_MPU6050_TRIGGER_INIT_RATE_DIVIDER 5
