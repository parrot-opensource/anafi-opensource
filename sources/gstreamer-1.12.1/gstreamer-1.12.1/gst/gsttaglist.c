...
_priv_gst_tag_initialize (void)
{
  ...
  gst_tag_register_static (GST_TAG_DEVICE_MODEL_ID, GST_TAG_FLAG_META,
      G_TYPE_STRING, _("device-model-id"), _("Device model ID"), NULL);
  gst_tag_register_static (GST_TAG_DEVICE_SERIAL, GST_TAG_FLAG_META,
      G_TYPE_STRING, _("device-serial"), _("Device serial ID"), NULL);
  gst_tag_register_static (GST_TAG_SOFTWARE_VERSION, GST_TAG_FLAG_META,
      G_TYPE_STRING, _("software-version"), _("Softwate version"), NULL);
  gst_tag_register_static (GST_TAG_SOFTWARE_BUILD_ID, GST_TAG_FLAG_META,
      G_TYPE_STRING, _("software-build-id"),
      _("Software version build ID"), NULL);
  gst_tag_register_static (GST_TAG_RUN_ID, GST_TAG_FLAG_META,
      G_TYPE_STRING, _("run-id"), _("Run ID"), NULL);
  gst_tag_register_static (GST_TAG_RUN_DATE, GST_TAG_FLAG_META,
