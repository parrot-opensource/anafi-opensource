...
/* buffer checker */
typedef gboolean (*GstBufferChecker) (GstBuffer * buffer, gpointer data);
void gst_buffer_set_checker (GstBuffer * buffer, GstBufferChecker checker, gpointer data);
gboolean gst_buffer_check (GstBuffer * buffer);
