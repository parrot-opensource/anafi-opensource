...
/**
 * GST_TAG_DEVICE_MODEL_ID:
 *
 * ID of the device model that create the media (string)
 */
#define GST_TAG_DEVICE_MODEL_ID                       "device-model-id"

/**
 * GST_TAG_DEVICE_SERIAL:
 *
 * Serial number of the device that create the media (string)
 */
#define GST_TAG_DEVICE_SERIAL                         "device-serial"

/**
 * GST_TAG_SOFTWARE_VERSION:
 *
 * Software version of the device that create the media (string)
 */
#define GST_TAG_SOFTWARE_VERSION                      "software-version"

/**
 * GST_TAG_SOFTWARE_BUILD_ID:
 *
 * Software build id of device that create the media (string)
 */
#define GST_TAG_SOFTWARE_BUILD_ID                     "software-build-id"

/**
 * GST_TAG_RUN_ID:
 *
 * Run ID of the media (string)
 */
#define GST_TAG_RUN_ID                                "run-id"

/**
 * GST_TAG_RUN_DATE:
 *
 * Run date of the media (ie: date of the session) (string)
 */
#define GST_TAG_RUN_DATE                              "run-date"

/**
 * GST_TAG_BOOT_ID:
 *
 * Boot UUID of the media (string)
 */
