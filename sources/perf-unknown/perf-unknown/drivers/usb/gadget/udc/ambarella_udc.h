...
struct ambarella_udc {
	...
	/* This fifo is used as a buffer ring for
	 * pre-allocated IN usb_ctrlrequest */
	DECLARE_KFIFO(ctrlreq_fifo, struct usb_ctrlrequest, USBCTRL_MAXPACKETS);
};
