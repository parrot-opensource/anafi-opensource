...
gst_tag_register_tags_internal (gpointer unused)
{
  ...
  gst_tag_register_static (GST_TAG_CAPTURING_FOCAL_PLANE_X_RESOLUTION,
      GST_TAG_FLAG_META, G_TYPE_DOUBLE,
      _("capturing focal plane x resolution"),
      _("The number of pixels in X direction per unit of camera focal plane"),
      NULL);

  gst_tag_register_static (GST_TAG_CAPTURING_FOCAL_PLANE_Y_RESOLUTION,
      GST_TAG_FLAG_META, G_TYPE_DOUBLE,
      _("capturing focal plane y resolution"),
      _("The number of pixels in Y direction per unit of camera focal plane"),
      NULL);

  gst_tag_register_static (GST_TAG_CAPTURING_FOCAL_PLANE_RESOLUTION_UNIT,
      GST_TAG_FLAG_META, G_TYPE_STRING,
      _("capturing focal plane resolution unit"),
      _("The unit for measuring focal plane resolution"), NULL);

  gst_tag_register_static (GST_TAG_CAPTURING_WHITE_BALANCE_R_GAIN,
      GST_TAG_FLAG_META, G_TYPE_DOUBLE, _("white balance r gain"),
      _("The white balance red gain"), NULL);

  gst_tag_register_static (GST_TAG_CAPTURING_WHITE_BALANCE_B_GAIN,
      GST_TAG_FLAG_META, G_TYPE_DOUBLE, _("white balance b gain"),
      _("The white balance blue gain"), NULL);

  gst_tag_register_static (GST_TAG_IMAGE_COMPONENTS_CONFIGURATION,
      GST_TAG_FLAG_META, G_TYPE_STRING, _("components configuration"),
      _("The arrangement of compressed data components"), NULL);
  gst_tag_register_static (GST_TAG_IMAGE_COLOR_SPACE, GST_TAG_FLAG_META,
      G_TYPE_STRING, _("color space"),
      _("The color space used to encode the image"), NULL);

  gst_tag_register_static (GST_TAG_IMAGE_PIXEL_X_DIMENSION, GST_TAG_FLAG_META,
      G_TYPE_INT, _("compressed image width"),
      _("The valid width of the meaningful image"), NULL);

  gst_tag_register_static (GST_TAG_IMAGE_PIXEL_Y_DIMENSION, GST_TAG_FLAG_META,
      G_TYPE_INT, _("compressed image height"),
      _("The valid height of the meaningful image"), NULL);
  ...
  gst_tag_register_static (GST_TAG_DRONE_PITCH, GST_TAG_FLAG_META,
      G_TYPE_FLOAT, _("drone-pitch"), _("Drone pitch angle in NED"), NULL);
  ...
  gst_tag_register_static (GST_TAG_CAMERA_PITCH, GST_TAG_FLAG_META,
      G_TYPE_FLOAT, _("camera-pitch"), _("Camera pitch angle in NED"), NULL);
