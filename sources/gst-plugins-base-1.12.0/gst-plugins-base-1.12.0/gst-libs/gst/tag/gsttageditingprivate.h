...
gint __exif_tag_image_chroma_positioning_to_exif_value (const gchar * str);
const gchar * __exif_tag_image_chroma_positioning_from_exif_value (gint value);

gint __exif_tag_image_color_space_to_exif_value (const gchar * str);
const gchar * __exif_tag_image_color_space_from_exif_value (gint value);

gint __exif_tag_capturing_focal_plane_resolution_unit_to_exif_value (const gchar * str);
const gchar * __exif_tag_capturing_focal_plane_resolution_unit_from_exif_value (gint value);
